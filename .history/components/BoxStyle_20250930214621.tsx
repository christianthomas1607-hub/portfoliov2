...
const triangleArray = new Float32Array([-1, -2, 0, 0, 0, 0, -2, 0, 0]);
  ...
  return (
    <>
      ...
      <mesh position={[0, -.69, 0]} rotation={[0, Math.PI / rotationY, 0]}>
        {/* Upside-down triangle using BufferGeometry with 3 vertices (XY plane).
            Added a normal attribute so lighting/shaders that depend on normals work
            (avoids invisible geometry when a custom material expects normals).
        */}
        <bufferGeometry>
          <bufferAttribute
