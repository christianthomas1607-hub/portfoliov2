...
export default function Page() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden' }}>
      <img className="controlKeys" src="/cthomasportfolio/window.svg" 
       style={{ width: '70%', overflow: 'hidden', position: 'absolute', top: '60px', left: '60px'}}
      alt="control keys" />
      <Canvas  style={{ background: 'white' }} shadows>     
        ...
        timeStep="vary">
          ...
          <RigidBody type="fixed" colliders="trimesh">
            ...
            scale={1.5} 
              src="/cthomasportfolio/star_destroyer_hallway.glb" />
            </RigidBody>
        </Physics>
